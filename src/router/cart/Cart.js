...
const BOT_TOKEN = "6212058636:AAFXNvAWt09X10TjXulkQCMNN8WpC3bPUuU"
const CHAT_ID = "-961546278"
...
function Cart() {
  ...
  // useState yordami qiymat olsak - Cantrolled form
  ...
  // useRef yordami qiymat olsak - Uncantrolled form
  const tel = useRef()
  ...
  return (
    <div>
      ...
      <div className='container'>
        <p>Savatingiz,</p> <p>Siz harid qilmaqchi bo'lgan mahsulotlar</p>
        <div className="choy">
        <div className="border">
        <div className="bosh">
        <p>Sizning mahsulotlaringiz</p>
        <div className="first"><p>Yetkazib berish xizmati mavjud</p>
        </div>
        </div>
        <hr className='hr' />
        {
          cart?.map((item, inx) => <div key={inx}>
            <div className="cart">
            <div className="main">
            <img src={item?.url} width={120} alt="" />
            <div className="trash">
            <p className='item'>{item?.title}</p>
            <p className='quti' onClick={()=> dispatch({type: REMOVE_FROM_CART, payload: item})}><BsFillTrashFill />Trash</p>
            </div>
            </div>
            <div className="son">
            <p>Sotuvchi: Chayok.uz</p>
            <div className="btn">
            <button className='minus' onClick={()=> dispatch({type: DECREMENT_FROM_CART, payload: item})}>-</button>
      ...
      {/* partttttttttttttttttttt 2222222222 */}
          ...
          <div className="kichik">
            ...
            <div className="inp">
              ...
              <input ref={tel} type="number" placeholder='Telifon raqamigiz' /><br /><br />
